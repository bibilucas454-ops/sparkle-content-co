...
serve(async (req) => {
  ...
  try {
    // 1. JWT signature is automatically verified by Supabase API Gateway (verify_jwt = true).
    // The request will only reach this point if a valid Auth header is present.
